...
CREATE TABLE dbo.Person (ID integer PRIMARY KEY, 
...
INSERT INTO dbo.Person VALUES (5, 'Ken');
...
INSERT INTO dbo.friend VALUES (
(SELECT $node_id FROM dbo.Person WHERE name = 'John'),
(SELECT $node_id FROM dbo.Person WHERE name = 'Joseph'), 
'10/15/2012');

INSERT INTO dbo.friend VALUES (
(SELECT $node_id FROM dbo.Person WHERE name = 'John'),
(SELECT $node_id FROM dbo.Person WHERE name = 'Ken'), 
'10/15/2014');

-- use MATCH in SELECT to find friends of Alice
SELECT Person2.name,start_date , $from_id, $to_id
